...
from bioreaction_atlas.rdf import field_summary, guess_mapping, read_rdf  # noqa: E402
...
def main():
    ...
    if args.list_fields:
        ...
        print('\nSuggested mapping (verify before trusting it):')
        for column, field in guess_mapping(rows).items():
    ...
    with out.open('w', newline='') as handle:
        ...
        for row in rows:
            ...
            for column, field in mapping.items():
                ...
                record[column] = ' '.join(value.split()) if value else ''
